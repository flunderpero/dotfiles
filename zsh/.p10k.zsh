# Generated by Powerlevel10k configuration wizard on 2022-11-09 at 13:02 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_GCLOUD_PARTIAL_CONTENT_EXPANSION='${P9K_GCLOUD_PROJECT_ID//*live/%{$fg[red]%\}- - - LIVE - - -}'
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION=$POWERLEVEL9K_GCLOUD_PARTIAL_CONTENT_EXPANSION
